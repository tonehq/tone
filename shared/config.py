...
class Settings:
    def __init__(self):
        ...
        self.DATABASE_URL: str = "postgresql://neondb_owner:npg_HPjY5NERS7Uf@ep-crimson-boat-aq6kyekg.c-8.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require"
