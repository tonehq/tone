...
- **`get_outbound_call_capacity(org_id)`** (`core/services/outbound_capacity.py`) — the single (currently permissive stub) home for outbound concurrent-call capacity; called before dispatch.
