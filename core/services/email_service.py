...
class MailService:
    ...
    def send_signup_email(self, to: str, verification_url: str, username: str = "User"):
        try:
            ...
            """
            params = {
                "from": "no-reply@updates.trytone.ai",
                "to": [to],
                    ...
                    <tr>
                        <td align="center">
                            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; border: 1px solid #e5e7eb; overflow: hidden;">
                                ...
                                <tr>
                                    <td align="center" style="padding: 20px 40px 10px 40px;">
                                        <h2 style="margin: 0; font-size: 24px; font-weight: 700; color: #111827;">You're Invited!</h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" style="padding: 0 40px 10px 40px;">
                                        <h3 style="margin: 0; font-size: 20px; font-weight: 600; color: #111827;">Join the team on Tone</h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" style="padding: 0 40px 30px 40px;">
                                        <p style="margin: 0; font-size: 14px; color: #6b7280; line-height: 1.6; max-width: 400px;">
                                            {inviter_name} has invited you to join their organization on Tone. Click the button below to accept the invitation and get started.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" style="padding: 0 40px 40px 40px;">
                                        <a href="{invite_url}" style="display: inline-block; background-color: #111827; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-size: 14px; font-weight: 500;">
                                            Accept Invitation
                                        </a>
                                    </td>
                                </tr>
