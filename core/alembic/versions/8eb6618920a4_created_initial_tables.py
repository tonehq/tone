...
Revision ID: 8eb6618920a4
Revises: 
Create Date: 2026-01-29 20:44:34.590150
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', name='member_user_unique')
    )
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', name='org_access_request_unique')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('email', name='invite_email_unique'),
