...
class VectorIndexArgs:
    def __init__(__self__, *,
                 dimension_count: pulumi.Input[_builtins.float],
                 region: pulumi.Input[_builtins.str],
                 similarity_function: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.float] dimension_count: Size of the vector array.
        :param pulumi.Input[_builtins.str] region: The region where your index is deployed.
        :param pulumi.Input[_builtins.str] similarity_function: Associated distance metric to calculate the similarity.
        :param pulumi.Input[_builtins.str] type: Associated plan of the index. Either <span pulumi-lang-nodejs="`free`" pulumi-lang-dotnet="`Free`" pulumi-lang-go="`free`" pulumi-lang-python="`free`" pulumi-lang-yaml="`free`" pulumi-lang-java="`free`" pulumi-lang-hcl="`free`">`free`</span>, <span pulumi-lang-nodejs="`paid`" pulumi-lang-dotnet="`Paid`" pulumi-lang-go="`paid`" pulumi-lang-python="`paid`" pulumi-lang-yaml="`paid`" pulumi-lang-java="`paid`" pulumi-lang-hcl="`paid`">`paid`</span>, <span pulumi-lang-nodejs="`fixed`" pulumi-lang-dotnet="`Fixed`" pulumi-lang-go="`fixed`" pulumi-lang-python="`fixed`" pulumi-lang-yaml="`fixed`" pulumi-lang-java="`fixed`" pulumi-lang-hcl="`fixed`">`fixed`</span> or <span pulumi-lang-nodejs="`pro`" pulumi-lang-dotnet="`Pro`" pulumi-lang-go="`pro`" pulumi-lang-python="`pro`" pulumi-lang-yaml="`pro`" pulumi-lang-java="`pro`" pulumi-lang-hcl="`pro`">`pro`</span>.
        :param pulumi.Input[_builtins.str] name: Name of the index.
        :param pulumi.Input[_builtins.float] reserved_price: Monthly pricing of your index. Only available for fixed and pro plans.
        """
    ...
    def dimension_count(self) -> pulumi.Input[_builtins.float]:
        """
    ...
    def dimension_count(self, value: pulumi.Input[_builtins.float]):
    ...
    def similarity_function(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def similarity_function(self, value: pulumi.Input[_builtins.str]):
    ...
    def type(self) -> pulumi.Input[_builtins.str]:
        """
        Associated plan of the index. Either <span pulumi-lang-nodejs="`free`" pulumi-lang-dotnet="`Free`" pulumi-lang-go="`free`" pulumi-lang-python="`free`" pulumi-lang-yaml="`free`" pulumi-lang-java="`free`" pulumi-lang-hcl="`free`">`free`</span>, <span pulumi-lang-nodejs="`paid`" pulumi-lang-dotnet="`Paid`" pulumi-lang-go="`paid`" pulumi-lang-python="`paid`" pulumi-lang-yaml="`paid`" pulumi-lang-java="`paid`" pulumi-lang-hcl="`paid`">`paid`</span>, <span pulumi-lang-nodejs="`fixed`" pulumi-lang-dotnet="`Fixed`" pulumi-lang-go="`fixed`" pulumi-lang-python="`fixed`" pulumi-lang-yaml="`fixed`" pulumi-lang-java="`fixed`" pulumi-lang-hcl="`fixed`">`fixed`</span> or <span pulumi-lang-nodejs="`pro`" pulumi-lang-dotnet="`Pro`" pulumi-lang-go="`pro`" pulumi-lang-python="`pro`" pulumi-lang-yaml="`pro`" pulumi-lang-java="`pro`" pulumi-lang-hcl="`pro`">`pro`</span>.
        """
...
class _VectorIndexState:
    def __init__(__self__, *,
                 ...
                 dimension_count: pulumi.Input[Optional[_builtins.float]] = None,
                 ...
                 reserved_price: pulumi.Input[Optional[_builtins.float]] = None,
                 similarity_function: pulumi.Input[Optional[_builtins.str]] = None,
                 token: pulumi.Input[Optional[_builtins.str]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None):
        """
        Input properties used for looking up and filtering VectorIndex resources.

        :param pulumi.Input[_builtins.float] creation_time: The creation time of the vector index in UTC as unix timestamp.
        :param pulumi.Input[_builtins.str] customer_id: The unique ID associated to the owner of this index.
        :param pulumi.Input[_builtins.float] dimension_count: Size of the vector array.
        :param pulumi.Input[_builtins.str] endpoint: Associated endpoint of your index.
        ...
        :param pulumi.Input[_builtins.float] max_monthly_bandwidth: The maximum amount of monthly bandwidth for the index. Unit is bytes. `-1` if the limit is unlimited.
        ...
        :param pulumi.Input[_builtins.float] max_total_metadata_size: The amount of maximum size for the total metadata sizes in your index.
        :param pulumi.Input[_builtins.float] max_vector_count: The number of maximum that your index can contain.
        ...
        :param pulumi.Input[_builtins.str] name: Name of the index.
        :param pulumi.Input[_builtins.str] read_only_token: Readonly REST token to send request to the related index. You can't perform update operation with this token.
        :param pulumi.Input[_builtins.str] region: The region where your index is deployed.
        :param pulumi.Input[_builtins.float] reserved_price: Monthly pricing of your index. Only available for fixed and pro plans.
        :param pulumi.Input[_builtins.str] similarity_function: Associated distance metric to calculate the similarity.
        :param pulumi.Input[_builtins.str] token: REST token to send request to the related index.
        :param pulumi.Input[_builtins.str] type: Associated plan of the index. Either <span pulumi-lang-nodejs="`free`" pulumi-lang-dotnet="`Free`" pulumi-lang-go="`free`" pulumi-lang-python="`free`" pulumi-lang-yaml="`free`" pulumi-lang-java="`free`" pulumi-lang-hcl="`free`">`free`</span>, <span pulumi-lang-nodejs="`paid`" pulumi-lang-dotnet="`Paid`" pulumi-lang-go="`paid`" pulumi-lang-python="`paid`" pulumi-lang-yaml="`paid`" pulumi-lang-java="`paid`" pulumi-lang-hcl="`paid`">`paid`</span>, <span pulumi-lang-nodejs="`fixed`" pulumi-lang-dotnet="`Fixed`" pulumi-lang-go="`fixed`" pulumi-lang-python="`fixed`" pulumi-lang-yaml="`fixed`" pulumi-lang-java="`fixed`" pulumi-lang-hcl="`fixed`">`fixed`</span> or <span pulumi-lang-nodejs="`pro`" pulumi-lang-dotnet="`Pro`" pulumi-lang-go="`pro`" pulumi-lang-python="`pro`" pulumi-lang-yaml="`pro`" pulumi-lang-java="`pro`" pulumi-lang-hcl="`pro`">`pro`</span>.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dimensionCount")
    def dimension_count(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
        Size of the vector array.
        """
        return pulumi.get(self, "dimension_count")
    ...
    @dimension_count.setter
    def dimension_count(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "dimension_count", value)
    ...
    @_builtins.property
    @pulumi.getter(name="similarityFunction")
    def similarity_function(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Associated distance metric to calculate the similarity.
        """
        return pulumi.get(self, "similarity_function")
    ...
    @similarity_function.setter
    def similarity_function(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "similarity_function", value)
...
@pulumi.type_token("upstash:index/vectorIndex:VectorIndex")
class VectorIndex(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            similarity_function: pulumi.Input[Optional[_builtins.str]] = None,
            token: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None) -> 'VectorIndex':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dimensionCount")
    def dimension_count(self) -> pulumi.Output[_builtins.float]:
        """
        Size of the vector array.
        """
        return pulumi.get(self, "dimension_count")
    ...
    @_builtins.property
    @pulumi.getter(name="similarityFunction")
    def similarity_function(self) -> pulumi.Output[_builtins.str]:
        """
        Associated distance metric to calculate the similarity.
        """
        return pulumi.get(self, "similarity_function")
