...
class JwksUrlArgs:
    def __init__(__self__, *,
                 ...
                 jwks_url_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def jwks_url_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        return pulumi.get(self, "jwks_url_id")

    @jwks_url_id.setter
    def jwks_url_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class JwksUrl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_id: pulumi.Input[Optional[_builtins.str]] = None,
            provider_name: pulumi.Input[Optional[_builtins.str]] = None,
            role_names: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'JwksUrl':
        """
