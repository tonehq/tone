...
@pulumi.output_type
class ProjectMaintenanceWindow(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "endTime":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ProjectMaintenanceWindow. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ProjectMaintenanceWindow.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 weekdays: Sequence[_builtins.float]):
        """
        :param _builtins.str end_time: End time of the maintenance window, in the format of "HH:MM". Uses UTC.
        :param _builtins.str start_time: Start time of the maintenance window, in the format of "HH:MM". Uses UTC.
        :param Sequence[_builtins.float] weekdays: A list of weekdays when the maintenance window is active. Encoded as ints, where 1 - Monday, and 7 - Sunday.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def weekdays(self) -> Sequence[_builtins.float]:
        """
...
class GetBranchesBranchResult(dict):
    def __init__(__self__, *,
                 id: Optional[_builtins.str] = None,
                 logical_size: Optional[_builtins.float] = None,
                 name: Optional[_builtins.str] = None,
    ...
    def logical_size(self) -> Optional[_builtins.float]:
