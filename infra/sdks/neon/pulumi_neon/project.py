...
class ProjectArgs:
    def __init__(__self__, *,
                 ...
                 allowed_ips_protected_branches_only: pulumi.Input[Optional[_builtins.str]] = None,
                 block_public_connections: pulumi.Input[Optional[_builtins.str]] = None,
                 block_vpc_connections: pulumi.Input[Optional[_builtins.str]] = None,
                 branch: pulumi.Input[Optional['ProjectBranchArgs']] = None,
                 compute_provisioner: pulumi.Input[Optional[_builtins.str]] = None,
                 default_branch_protected: pulumi.Input[Optional[_builtins.bool]] = None,
                 default_endpoint_settings: pulumi.Input[Optional['ProjectDefaultEndpointSettingsArgs']] = None,
                 enable_logical_replication: pulumi.Input[Optional[_builtins.str]] = None,
                 hipaa: pulumi.Input[Optional[_builtins.str]] = None,
                 history_retention_seconds: pulumi.Input[Optional[_builtins.float]] = None,
                 maintenance_window: pulumi.Input[Optional['ProjectMaintenanceWindowArgs']] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 org_id: pulumi.Input[Optional[_builtins.str]] = None,
                 pg_version: pulumi.Input[Optional[_builtins.float]] = None,
                 quota: pulumi.Input[Optional['ProjectQuotaArgs']] = None,
                 region_id: pulumi.Input[Optional[_builtins.str]] = None,
                 store_password: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a Project resource.

        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] allowed_ips: A list of IP addresses that are allowed to connect to the endpoints.
        ...
        :param pulumi.Input[_builtins.str] allowed_ips_protected_branches_only: Set to 'yes' to activate, 'no' to deactivate explicitly, and omit to keep the default value.
               Apply the allow-list to the protected branches only.
               Note that the feature is available to the Neon Scale plans only.
        :param pulumi.Input[_builtins.str] block_public_connections: Set to 'yes' to activate, 'no' to deactivate explicitly, and omit to keep the default value.
               Block connections from public internet. This supersedes the AllowedIPs list.
        :param pulumi.Input[_builtins.str] block_vpc_connections: Set to 'yes' to activate, 'no' to deactivate explicitly, and omit to keep the default value.
               Block connections that use VPC endpoints.
        :param pulumi.Input[_builtins.str] compute_provisioner: Provisioner The Neon compute provisioner.
               Specify the k8s-neonvm provisioner to create a compute endpoint that supports Autoscaling.
        :param pulumi.Input[_builtins.bool] default_branch_protected: Set default branch as protected. **Note** that the default value is false.
        :param pulumi.Input[_builtins.str] enable_logical_replication: Set to 'yes' to activate, 'no' to deactivate explicitly, and omit to keep the default value.
        ...
        :param pulumi.Input[_builtins.str] hipaa: Set to 'yes' to activate, 'no' to deactivate explicitly, and omit to keep the default value.
        ...
        :param pulumi.Input[_builtins.float] history_retention_seconds: The number of seconds to retain the point-in-time restore (PITR) backup history for this project.
               Default: 1 day, see https://neon.tech/docs/reference/glossary#point-in-time-restore.
        :param pulumi.Input['ProjectMaintenanceWindowArgs'] maintenance_window: A time period during which Neon may perform maintenance on the project's infrastructure. During this time, the project's compute endpoints may be unavailable and existing connections can be interrupted.
        ...
        :param pulumi.Input['ProjectQuotaArgs'] quota: Per-project consumption quota. If the quota is exceeded, all active computes
        ...
        :param pulumi.Input[_builtins.str] store_password: Set to 'yes' to activate, 'no' to deactivate explicitly, and omit to keep the default value.
        ...
        if block_public_connections is not None:
            pulumi.set(__self__, "block_public_connections", block_public_connections)
        if block_vpc_connections is not None:
            pulumi.set(__self__, "block_vpc_connections", block_vpc_connections)
        if branch is not None:
            pulumi.set(__self__, "branch", branch)
        if compute_provisioner is not None:
            pulumi.set(__self__, "compute_provisioner", compute_provisioner)
        if default_branch_protected is not None:
            pulumi.set(__self__, "default_branch_protected", default_branch_protected)
    ...
    def allowed_ips_protected_branches_only(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def allowed_ips_protected_branches_only(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "allowed_ips_protected_branches_only", value)

    @_builtins.property
    @pulumi.getter(name="blockPublicConnections")
    def block_public_connections(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Set to 'yes' to activate, 'no' to deactivate explicitly, and omit to keep the default value.
        Block connections from public internet. This supersedes the AllowedIPs list.
        """
        return pulumi.get(self, "block_public_connections")

    @block_public_connections.setter
    def block_public_connections(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "block_public_connections", value)

    @_builtins.property
    @pulumi.getter(name="blockVpcConnections")
    def block_vpc_connections(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Set to 'yes' to activate, 'no' to deactivate explicitly, and omit to keep the default value.
        Block connections that use VPC endpoints.
        """
        return pulumi.get(self, "block_vpc_connections")

    @block_vpc_connections.setter
    def block_vpc_connections(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "block_vpc_connections", value)

    @_builtins.property
    @pulumi.getter
    def branch(self) -> pulumi.Input[Optional['ProjectBranchArgs']]:
        return pulumi.get(self, "branch")

    @branch.setter
    def branch(self, value: pulumi.Input[Optional['ProjectBranchArgs']]):
        pulumi.set(self, "branch", value)

    @_builtins.property
    @pulumi.getter(name="computeProvisioner")
    def compute_provisioner(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def compute_provisioner(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "compute_provisioner", value)

    @_builtins.property
    @pulumi.getter(name="defaultBranchProtected")
    def default_branch_protected(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Set default branch as protected. **Note** that the default value is false.
        """
        return pulumi.get(self, "default_branch_protected")

    @default_branch_protected.setter
    def default_branch_protected(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "default_branch_protected", value)

    @_builtins.property
    @pulumi.getter(name="defaultEndpointSettings")
    def default_endpoint_settings(self) -> pulumi.Input[Optional['ProjectDefaultEndpointSettingsArgs']]:
        return pulumi.get(self, "default_endpoint_settings")

    @default_endpoint_settings.setter
    def default_endpoint_settings(self, value: pulumi.Input[Optional['ProjectDefaultEndpointSettingsArgs']]):
        pulumi.set(self, "default_endpoint_settings", value)

    @_builtins.property
    @pulumi.getter(name="enableLogicalReplication")
    def enable_logical_replication(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Set to 'yes' to activate, 'no' to deactivate explicitly, and omit to keep the default value.
        Sets wal_level=logical for all compute endpoints in this project.
        All active endpoints will be suspended. See details: https://neon.tech/docs/introduction/logical-replication
    ...
    def enable_logical_replication(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "enable_logical_replication", value)

    @_builtins.property
    @pulumi.getter
    def hipaa(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Set to 'yes' to activate, 'no' to deactivate explicitly, and omit to keep the default value.
        Enable HIPAA compliance for the project.
        Note that HIPAA must be configured for the organization first.
    ...
    @hipaa.setter
    def hipaa(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "hipaa", value)

    @_builtins.property
    @pulumi.getter(name="historyRetentionSeconds")
    def history_retention_seconds(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def history_retention_seconds(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "history_retention_seconds", value)

    @_builtins.property
    @pulumi.getter(name="maintenanceWindow")
    def maintenance_window(self) -> pulumi.Input[Optional['ProjectMaintenanceWindowArgs']]:
        """
    ...
    def maintenance_window(self, value: pulumi.Input[Optional['ProjectMaintenanceWindowArgs']]):
    ...
    def pg_version(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
        Postgres version
        """
    ...
    @pg_version.setter
    def pg_version(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "pg_version", value)

    @_builtins.property
    @pulumi.getter
    def quota(self) -> pulumi.Input[Optional['ProjectQuotaArgs']]:
        """
    ...
    @quota.setter
    def quota(self, value: pulumi.Input[Optional['ProjectQuotaArgs']]):
...
class _ProjectState:
    def __init__(__self__, *,
                 ...
                 connection_uri_pooler: pulumi.Input[Optional[_builtins.str]] = None,
                 database_host: pulumi.Input[Optional[_builtins.str]] = None,
                 database_host_pooler: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 default_branch_id: pulumi.Input[Optional[_builtins.str]] = None,
                 default_branch_protected: pulumi.Input[Optional[_builtins.bool]] = None,
                 default_endpoint_id: pulumi.Input[Optional[_builtins.str]] = None,
                 default_endpoint_settings: pulumi.Input[Optional['ProjectDefaultEndpointSettingsArgs']] = None,
                 enable_logical_replication: pulumi.Input[Optional[_builtins.str]] = None,
                 hipaa: pulumi.Input[Optional[_builtins.str]] = None,
                 history_retention_seconds: pulumi.Input[Optional[_builtins.float]] = None,
    ...
    def connection_uri_pooler(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def connection_uri_pooler(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "connection_uri_pooler", value)

    @_builtins.property
    @pulumi.getter(name="databaseHost")
    def database_host(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def database_host(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "database_host", value)

    @_builtins.property
    @pulumi.getter(name="databaseHostPooler")
    def database_host_pooler(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def database_host_pooler(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def default_branch_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Default branch ID.
        """
    ...
    def default_branch_id(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def default_endpoint_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Default endpoint ID.
        """
    ...
    def default_endpoint_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class Project(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 block_public_connections: pulumi.Input[Optional[_builtins.str]] = None,
                 block_vpc_connections: pulumi.Input[Optional[_builtins.str]] = None,
                 branch: pulumi.Input[Optional[Union['ProjectBranchArgs', 'ProjectBranchArgsDict']]] = None,
                 compute_provisioner: pulumi.Input[Optional[_builtins.str]] = None,
                 default_branch_protected: pulumi.Input[Optional[_builtins.bool]] = None,
                 default_endpoint_settings: pulumi.Input[Optional[Union['ProjectDefaultEndpointSettingsArgs', 'ProjectDefaultEndpointSettingsArgsDict']]] = None,
                 enable_logical_replication: pulumi.Input[Optional[_builtins.str]] = None,
                 hipaa: pulumi.Input[Optional[_builtins.str]] = None,
                 history_retention_seconds: pulumi.Input[Optional[_builtins.float]] = None,
                 maintenance_window: pulumi.Input[Optional[Union['ProjectMaintenanceWindowArgs', 'ProjectMaintenanceWindowArgsDict']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 org_id: pulumi.Input[Optional[_builtins.str]] = None,
                 pg_version: pulumi.Input[Optional[_builtins.float]] = None,
                 quota: pulumi.Input[Optional[Union['ProjectQuotaArgs', 'ProjectQuotaArgsDict']]] = None,
                 region_id: pulumi.Input[Optional[_builtins.str]] = None,
                 store_password: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.float] history_retention_seconds: The number of seconds to retain the point-in-time restore (PITR) backup history for this project.
               Default: 1 day, see https://neon.tech/docs/reference/glossary#point-in-time-restore.
        :param pulumi.Input[Union['ProjectMaintenanceWindowArgs', 'ProjectMaintenanceWindowArgsDict']] maintenance_window: A time period during which Neon may perform maintenance on the project's infrastructure. During this time, the project's compute endpoints may be unavailable and existing connections can be interrupted.
        :param pulumi.Input[_builtins.str] name: Project name.
        :param pulumi.Input[_builtins.str] org_id: Identifier of the organisation to which this project belongs.
        :param pulumi.Input[_builtins.float] pg_version: Postgres version
        :param pulumi.Input[Union['ProjectQuotaArgs', 'ProjectQuotaArgsDict']] quota: Per-project consumption quota. If the quota is exceeded, all active computes
               are automatically suspended and it will not be possible to start them with
               an API method call or incoming proxy connections. The only exception is
               logical_size_bytes, which is applied on per-branch basis, i.e., only the
               compute on the branch that exceeds the<span pulumi-lang-nodejs=" logicalSize " pulumi-lang-dotnet=" LogicalSize " pulumi-lang-go=" logicalSize " pulumi-lang-python=" logical_size " pulumi-lang-yaml=" logicalSize " pulumi-lang-java=" logicalSize " pulumi-lang-hcl=" logical_size "> logicalSize </span>quota will be suspended.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["block_public_connections"] = block_public_connections
            __props__.__dict__["block_vpc_connections"] = block_vpc_connections
            __props__.__dict__["branch"] = branch
            __props__.__dict__["compute_provisioner"] = compute_provisioner
            __props__.__dict__["default_branch_protected"] = default_branch_protected
    ...
    def get(resource_name: str,
            ...
            quota: pulumi.Input[Optional[Union['ProjectQuotaArgs', 'ProjectQuotaArgsDict']]] = None,
            region_id: pulumi.Input[Optional[_builtins.str]] = None,
            store_password: pulumi.Input[Optional[_builtins.str]] = None) -> 'Project':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="blockPublicConnections")
    def block_public_connections(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Set to 'yes' to activate, 'no' to deactivate explicitly, and omit to keep the default value.
        Block connections from public internet. This supersedes the AllowedIPs list.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="blockVpcConnections")
    def block_vpc_connections(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Set to 'yes' to activate, 'no' to deactivate explicitly, and omit to keep the default value.
        Block connections that use VPC endpoints.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="defaultBranchProtected")
    def default_branch_protected(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Set default branch as protected. **Note** that the default value is false.
        """
        return pulumi.get(self, "default_branch_protected")
    ...
    @_builtins.property
    @pulumi.getter
    def hipaa(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Set to 'yes' to activate, 'no' to deactivate explicitly, and omit to keep the default value.
        Enable HIPAA compliance for the project.
        Note that HIPAA must be configured for the organization first.
    ...
    @_builtins.property
    @pulumi.getter(name="maintenanceWindow")
    def maintenance_window(self) -> pulumi.Output[Optional['outputs.ProjectMaintenanceWindow']]:
        """
        A time period during which Neon may perform maintenance on the project's infrastructure. During this time, the project's compute endpoints may be unavailable and existing connections can be interrupted.
        """
        return pulumi.get(self, "maintenance_window")
