...
class VpcEndpointAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 vpc_endpoint_assignment_id: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def vpc_endpoint_assignment_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        return pulumi.get(self, "vpc_endpoint_assignment_id")

    @vpc_endpoint_assignment_id.setter
    def vpc_endpoint_assignment_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class VpcEndpointAssignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region_id: pulumi.Input[Optional[_builtins.str]] = None,
            vpc_endpoint_assignment_id: pulumi.Input[Optional[_builtins.str]] = None,
            vpc_endpoint_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'VpcEndpointAssignment':
        """
