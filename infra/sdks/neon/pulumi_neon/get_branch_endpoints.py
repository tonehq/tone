...
def get_branch_endpoints_output(branch_id: pulumi.Input[Optional[_builtins.str]] = None,
                                endpoints: pulumi.Input[Optional[Optional[Sequence[Union['GetBranchEndpointsEndpointArgs', 'GetBranchEndpointsEndpointArgsDict']]]]] = None,
