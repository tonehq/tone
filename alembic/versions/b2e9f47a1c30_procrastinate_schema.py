...
Revision ID: b2e9f47a1c30
Revises: c1bb2881a3e0
Create Date: 2026-06-04
"""
from alembic import op
import sqlalchemy as sa

revision = "b2e9f47a1c30"
down_revision = "c1bb2881a3e0"
branch_labels = None
depends_on = None


PROCRASTINATE_SCHEMA_SQL = r"""
DO $$
BEGIN
...
def upgrade() -> None:
    ...
    already = bind.execute(
        sa.text("SELECT to_regclass('public.procrastinate_jobs')")
    ).scalar()
...
def downgrade() -> None:
    op.execute(PROCRASTINATE_DROP_SQL)
