...
def get_channel_phone_numbers(
    ...
    return ChannelPhoneNumbersService(db, org_id=UUID(claims.org_id)).get_channel_phone_numbers(channel_id)
...
def upsert_channel_phone_number(
    ...
    return ChannelPhoneNumbersService(db, org_id=UUID(claims.org_id)).upsert_channel_phone_numbers(data)
...
def detach_channel_phone_number(
    ...
    return ChannelPhoneNumbersService(db, org_id=UUID(claims.org_id)).detach_channel_phone_number(data)
...
def get_assigned_phone_numbers(
    ...
    return ChannelPhoneNumbersService(db, org_id=UUID(claims.org_id)).get_assigned_phone_numbers()
