...
def get_models_by_provider(
    ...
    Body: {model_provider_menu_id (required), name?, status?, service_type?, sort?, page?, page_size?}.
    """
    ...
    return ModelMenuService(db, org_id=UUID(claims.org_id)).get_models_by_provider(
...
def upsert_model(
    ...
    return ModelMenuService(db, org_id=UUID(claims.org_id)).upsert_model(data)
...
def delete_model(
    ...
    return ModelMenuService(db, org_id=UUID(claims.org_id)).delete_model(model_id)
