...
_ALLOWED_MI_SORT_FIELDS = {"created_at", "updated_at", "name", "display_name"}
...
def list_model_instances(
    ...
    """
    sort_by, sort_order = _parse_sort(data.get("sort"), _ALLOWED_MI_SORT_FIELDS)
...
def get_model_instance(
    ...
    return ModelInstanceService(
        db, org_id=UUID(claims.org_id), user_id=claims.user_id
    ).get_model_instance(instance_id)
...
def delete_model_instance(
    ...
    return ModelInstanceService(
        db, org_id=UUID(claims.org_id), user_id=claims.user_id
    ).delete_model_instance(instance_id)
