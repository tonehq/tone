...
> Generated: 2026-03-06T13:41:07.776357+00:00
> Comparing: `4e5e833b` → `907955ce`
...
|------|----------|--------|--------|--------|
| `src/app/auth/login/LoginPage.tsx` | app-config | modified | +41 | -92 |
| `src/app/auth/shared/ContainerComponent.tsx` | app-config | modified | +122 | -208 |
| `src/app/auth/signup/SignupClient.tsx` | app-config | modified | +28 | -71 |
...
| `src/components/agents/AgentFormPage.tsx` | component | added | +479 | -0 |
| `src/components/agents/AgentListPage.tsx` | component | modified | +93 | -144 |
...
| `src/components/agents/agent-form/DynamicProviderFields.tsx` | component | added | +438 | -0 |
| `src/components/agents/agent-form/GeneralTab.tsx` | component | modified | +286 | -175 |
| `src/components/agents/agent-form/VoiceSelect.tsx` | component | added | +150 | -0 |
| `src/components/agents/agent-form/VoiceTab.tsx` | component | modified | +331 | -235 |
...
| `src/components/shared/SelectInput.tsx` | component | added | +128 | -0 |
...
| `src/components/shared/index.tsx` | component | added | +46 | -0 |
...
| `src/app/auth/check-email/page.tsx` | page | modified | +20 | -67 |
| `src/app/auth/forgotpassword/page.tsx` | page | modified | +18 | -41 |
| `src/app/auth/reset-password/page.tsx` | page | modified | +15 | -37 |
...
| `src/types/provider.ts` | type | added | +42 | -0 |
...
```
src/components/settings/ApiKeysTab.tsx (component, added)
...
```
src/components/settings/PublicKeysTab.tsx (component, added)
...
src/components/shared/ActionMenu.tsx (component, added)
  → ActionMenu.tsx  → index.tsx  → page.tsx
  → /settings  [src/app/(dashboard)/settings/page.tsx]
```
...
src/components/shared/CustomLink.tsx (component, added)
  → CustomLink.tsx  → index.tsx  → page.tsx
  → /settings  [src/app/(dashboard)/settings/page.tsx]
```
...
src/components/shared/CustomModal.tsx (component, added)
  → CustomModal.tsx  → index.tsx  → page.tsx
  → /settings  [src/app/(dashboard)/settings/page.tsx]
```
...
src/components/shared/CustomTab.tsx (component, added)
  → CustomTab.tsx  → index.tsx  → page.tsx
  → /settings  [src/app/(dashboard)/settings/page.tsx]
```
...
src/components/shared/Divider.tsx (component, added)
  → Divider.tsx  → index.tsx  → page.tsx
  → /settings  [src/app/(dashboard)/settings/page.tsx]
```
...
src/components/shared/SearchableSelect.tsx (component, added)
  → SearchableSelect.tsx  → index.tsx  → page.tsx
  → /settings  [src/app/(dashboard)/settings/page.tsx]
```
...
```
src/components/ui/checkbox.tsx (component, added)
  → checkbox.tsx  → CheckboxField.tsx  → index.tsx  → page.tsx
  → /settings  [src/app/(dashboard)/settings/page.tsx]
```
...
```
src/components/ui/input.tsx (component, added)
  → input.tsx  → TextInput.tsx  → index.tsx  → page.tsx
  → /settings  [src/app/(dashboard)/settings/page.tsx]
```
...
```
src/components/ui/label.tsx (component, added)
  → label.tsx  → RadioGroupField.tsx  → index.tsx  → page.tsx
  → /settings  [src/app/(dashboard)/settings/page.tsx]
```
...
```
src/components/ui/label.tsx (component, added)
  → label.tsx  → RadioGroupField.tsx  → index.tsx  → AgentListPage.tsx  → page.tsx
  → /agents  [src/app/(dashboard)/agents/page.tsx]
```

```
src/components/ui/label.tsx (component, added)
  → label.tsx  → RadioGroupField.tsx  → index.tsx  → AgentFormPage.tsx  → page.tsx
  → /agents/create/inbound  [src/app/(dashboard)/agents/create/inbound/page.tsx]
```
...
```
src/components/ui/label.tsx (component, added)
  → label.tsx  → RadioGroupField.tsx  → index.tsx  → LoginPage.tsx  → page.tsx
  → /auth/login  [src/app/auth/login/page.tsx]
```

```
src/components/ui/popover.tsx (component, added)
  → popover.tsx  → SearchableSelect.tsx  → index.tsx  → page.tsx
  → /settings  [src/app/(dashboard)/settings/page.tsx]
```
...
src/components/ui/radio-group.tsx (component, added)
  → radio-group.tsx  → RadioGroupField.tsx  → index.tsx  → page.tsx
  → /settings  [src/app/(dashboard)/settings/page.tsx]
```
...
src/components/ui/select.tsx (component, added)
  → select.tsx  → SelectInput.tsx  → index.tsx  → page.tsx
  → /settings  [src/app/(dashboard)/settings/page.tsx]
```
...
src/components/ui/textarea.tsx (component, added)
  → textarea.tsx  → TextAreaField.tsx  → index.tsx  → page.tsx
  → /settings  [src/app/(dashboard)/settings/page.tsx]
```
