...
export const OAUTH_PROVIDERS: ProviderCardConfig[] = [
  {
    ...
    iconBg: 'bg-white dark:bg-white/95',
    iconBorder: 'border-border/50 shadow-sm',
  ...
  },
  {
    ...
    iconBorder: 'border-emerald-200/50 dark:border-emerald-500/20 shadow-sm',
...
export const API_KEY_PROVIDERS: ProviderCardConfig[] = [
  {
    ...
    iconBorder: 'border-red-200/50 dark:border-red-500/20 shadow-sm',
  ...
  },
  {
    ...
    iconBorder: 'border-teal-200/50 dark:border-teal-500/20 shadow-sm',
  ...
  },
  {
    ...
    iconBorder: 'border-blue-200/50 dark:border-blue-500/20 shadow-sm',
    accentColor: 'bg-blue-500',
  },
];
