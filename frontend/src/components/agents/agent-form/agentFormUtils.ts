/** Form state shape used by both create and edit (inbound/outbound). */
...
/** Map API agent to form state for edit page. */
...
/** Build upsert payload from form state (and optional agent id for update). */
