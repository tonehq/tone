...
interface ButtonProps {
  icon?: LucideIcon | React.ReactNode;  text?: string;
  onClick?: () => void;
  active?: boolean;
  disabled?: boolean;
  className?: string;
    ...
    return (
        <>
            ...
            <Button
                ...
                style={{ height: "36px", borderRadius: "5px", fontWeight: 500, textAlign: "center" , background: active ? "#1D4ED8" : "", color: active ? "white" : "#334155" }}
            ...
            (<Button
                type={type ? type : "default"}
                style={{ height: "36px", borderRadius: "5px", textAlign: "center" , background: active ? "#1D4ED8" : "", color: active ? "white" : "#334155" }}
                className={`border-slate-200 !outline-none !ring-0 !shadow-none h-9  bg-white text-sm text-slate-700 hover:bg-slate-50 ${className}`}
                onClick={onClick}
                disabled={disabled}
                htmlType={htmlType}
